...
})({"eF5RL":[function(require,module,exports) {
...
$(document).ready(function() {
    ...
    $(".faq_accordian-button").click(function() {
        ...
        if (!isIconActive) $(this).find(".faq_accordian-button-icon").addClass("accordian-active-icon");
        if (!isActive) $(this).parent(".faq-accordian-item").addClass("accordian-active");
...
},{}]},["eF5RL","adjPd"], "adjPd", "parcelRequire89d5")
